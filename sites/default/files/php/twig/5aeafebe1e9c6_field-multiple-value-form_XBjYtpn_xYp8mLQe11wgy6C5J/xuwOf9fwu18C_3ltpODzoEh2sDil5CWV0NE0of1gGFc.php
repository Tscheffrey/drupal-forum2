...
class __TwigTemplate_23ed260eaa967d4f6c127201c970d2f9e57c9f05bde75c79c60565cb25e1b825 extends Twig_Template
{
    ...
    ";
            ...
            if ($this->getAttribute(($context["description"] ?? null), "content", array())) {
                // line 26
                echo "      <div";
                echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute($this->getAttribute(($context["description"] ?? null), "attributes", array()), "addClass", array(0 => "w3-small description"), "method"), "html", null, true));
                echo " >";
...
";
  ...
  ";
    ...
    {
        return new Twig_Source("", "themes/d8w3css/templates/form/field-multiple-value-form.html.twig", "/Users/Hannes/Documents/development/htdocs/drupal3/themes/d8w3css/templates/form/field-multiple-value-form.html.twig");
    }
}
